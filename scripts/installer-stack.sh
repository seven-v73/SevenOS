...
release_json() {
  ...
  calamares_livecleanup_state="$([[ $(contains_state installer/calamares/settings.conf "shellprocess@livecleanup") == OK && $(contains_state installer/calamares/settings.conf "shellprocess-livecleanup.conf") == OK && $(contains_state installer/calamares/modules/shellprocess-livecleanup.conf "/usr/local/bin/seven-calamares-livecleanup") == OK && $(contains_state installer/calamares/modules/shellprocess-livecleanup.conf "/opt/SevenOS/bin/seven-calamares-livecleanup") == OK && $(contains_state installer/calamares/modules/shellprocess-livecleanup.conf "/bin/bash -lc") == OK && $(contains_state installer/calamares/modules/shellprocess-livecleanup.conf "finalizer will continue cleanup later") == OK && $(contains_state bin/seven-calamares-livecleanup "without touching running live processes") == OK && $(contains_state bin/seven-calamares-livecleanup "target passwd file is missing") == OK && $(contains_state archiso/profile/airootfs/root/customize_airootfs.sh "seven-calamares-livecleanup") == OK ]] && printf OK || printf MISS)"
  calamares_postinstall_state="$([[ $(contains_state installer/calamares/modules/shellprocess.conf "/usr/local/bin/seven-calamares-finalize") == OK && $(contains_state installer/calamares/modules/shellprocess.conf "/opt/SevenOS/bin/seven-calamares-finalize") == OK && $(contains_state installer/calamares/modules/shellprocess.conf "/bin/bash -lc") == OK && $(contains_state bin/seven-calamares-finalize "Clean live ISO residue") == OK && $(contains_state bin/seven-calamares-finalize "Configure network stack") == OK && $(contains_state bin/seven-calamares-finalize "Configure display stack") == OK && $(contains_state bin/seven-calamares-finalize "skipping network package installs during Calamares finalization") == OK && $(contains_state bin/seven-calamares-finalize "run_optional_step") == OK && $(contains_state bin/seven-calamares-finalize "NetworkManager.service") == OK && $(contains_state bin/seven-calamares-finalize "sddm.service") == OK && $(contains_state installer/calamares/settings.conf "- displaymanager") != OK && $(contains_state installer/calamares/settings.conf "- networkcfg") != OK && $(not_regex_state bin/seven-calamares-finalize 'install\\.sh"[[:space:]]+base|install\\.sh[[:space:]]+base') == OK && -x "$ROOT_DIR/bin/seven-calamares-finalize" ]] && printf OK || printf MISS)"
  ...
  native_live_ui_state="$([[ $(contains_state bin/seven-installer-native "live-status") == OK && $(contains_state bin/seven-installer-native "status_cards") == OK && $(contains_state bin/seven-installer-native "installer-progress") == OK && $(contains_state bin/seven-installer-native "timeline_steps") == OK && $(contains_state bin/seven-installer-native "apply_timeline_strip") == OK && $(contains_state bin/seven-installer-native "installer-step-active") == OK && $(contains_state bin/seven-installer-native "preflight_chips") == OK && $(contains_state bin/seven-installer-native "apply_preflight_cards") == OK && $(contains_state bin/seven-installer-native "timeline_card") == OK && $(contains_state bin/seven-installer-native "GLib.timeout_add_seconds") == OK && $(contains_state bin/seven-installer-native "active_step_label") == OK && $(contains_state bin/seven-installer-native "decision_label") == OK && $(contains_state bin/seven-installer-native "attention_label") == OK && $(contains_state bin/seven-installer-native "flow_hint_label") == OK && $(contains_state bin/seven-installer-native "recovery_hint_label") == OK && $(contains_state bin/seven-installer-native "Gtk.FlowBox") == OK && $(contains_state bin/seven-installer-native "primary_live_action") == OK && $(contains_state bin/seven-installer-native "secondary_action_buttons") == OK && $(contains_state bin/seven-installer-native "seven-installer logs") == OK && $(contains_state bin/seven-installer-native "seven-installer disks") == OK && $(contains_state bin/seven-installer "user_message") == OK && $(contains_state bin/seven-installer "primary_command") == OK && $(contains_state bin/seven-installer "secondary_actions") == OK && $(contains_state bin/seven-installer "attention_items") == OK ]] && printf OK || printf MISS)"
  ...
  live_session_state="$([[ -x "$ROOT_DIR/archiso/profile/airootfs/usr/local/bin/sevenos-live-session" && -x "$ROOT_DIR/archiso/profile/airootfs/usr/local/bin/sevenos-live-guard" && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-session "starting SevenOS installer kiosk") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-session "cage -s -- seven-installer open") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-session "starting Hyprland fallback") == OK && $(contains_state archiso/profile/airootfs/etc/systemd/system/sevenos-live-session.service "ExecStart=/usr/local/bin/sevenos-live-session") == OK && $(contains_state archiso/profile/airootfs/root/customize_airootfs.sh "sevenos-live-session.service") == OK && $(contains_state archiso/profile/airootfs/etc/sevenos/live-hyprland.conf "sevenos-live-guard") == OK ]] && printf OK || printf MISS)"
  ...
  live_quiet_boot_state="$([[ $(contains_state archiso/profile/profiledef.sh "uefi.grub") == OK && $(contains_state archiso/profile/grub/grub.cfg "SevenOS Live") == OK && $(contains_state archiso/profile/grub/grub.cfg "Safe Graphics") == OK && $(contains_state archiso/profile/grub/grub.cfg "set timeout=20") == OK && $(contains_state archiso/profile/grub/grub.cfg "set menu_color_normal=white/black") == OK && $(contains_state archiso/profile/grub/grub.cfg "set menu_color_highlight=black/white") == OK && $(contains_state archiso/profile/grub/loopback.cfg "SevenOS Live") == OK && $(contains_state archiso/profile/grub/loopback.cfg "set menu_color_normal=white/black") == OK && $(contains_state archiso/profile/efiboot/loader/entries/01-sevenos-live.conf "quiet splash") == OK && $(contains_state archiso/profile/efiboot/loader/entries/01-sevenos-live.conf "loglevel=0") == OK && $(contains_state archiso/profile/efiboot/loader/entries/01-sevenos-live.conf "systemd.show_status=false") == OK && $(contains_state archiso/profile/syslinux/archiso_sys-linux.cfg "quiet splash") == OK && $(contains_state archiso/profile/syslinux/archiso_sys-linux.cfg "loglevel=0") == OK && $(contains_state archiso/profile/syslinux/archiso_head.cfg "UI menu.c32") == OK && $(contains_state archiso/profile/syslinux/archiso_head.cfg "SevenOS Boot Menu") == OK && $(contains_state archiso/profile/syslinux/archiso_head.cfg "MENU COLOR sel") == OK && $(contains_state archiso/profile/efiboot/loader/entries/03-sevenos-live-safe.conf "Safe Graphics") == OK && $(contains_state archiso/profile/syslinux/archiso_sys-linux.cfg "Safe ^Graphics") == OK ]] && printf OK || printf MISS)"
  ...
  live_user_config_state="$([[ $(contains_state archiso/profile/airootfs/root/customize_airootfs.sh "/home/seven/.config/hypr/hyprland.conf") == OK && $(contains_state archiso/profile/airootfs/root/customize_airootfs.sh "locale-gen") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-session "locale_available") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-session "read_language_value") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-session "SEVENOS_LIVE_SESSION_LOCALE_PROBE") == OK && $(contains_state archiso/profile/airootfs/etc/systemd/system/sevenos-live-session.service "StandardOutput=journal") == OK ]] && printf OK || printf MISS)"
  ...
  live_network_status_state="$([[ $(contains_state bin/seven-installer "NM_STATE") == OK && $(contains_state bin/seven-installer "connect-network") == OK && $(contains_state bin/seven-installer "network_command") == OK && $(contains_state bin/seven-installer "logs_command") == OK && $(contains_state bin/seven-installer "Installer hors ligne") == OK && $(contains_state bin/seven-installer "live-offline-accepted") == OK && $(contains_state archiso/profile/airootfs/usr/share/applications/seven-installer.desktop "Desktop Action Network") == OK && $(contains_state archiso/profile/airootfs/usr/share/applications/seven-installer.desktop "Desktop Action Logs") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-ready "Network is not connected; opening SevenOS network choice before installation.") == OK ]] && printf OK || printf MISS)"
  live_storage_status_state="$([[ $(contains_state bin/seven-installer "install_targets") == OK && $(contains_state bin/seven-installer "disks_command") == OK && $(contains_state archiso/profile/packages.x86_64 "gnome-disk-utility") == OK && $(contains_state archiso/profile/airootfs/usr/share/applications/seven-installer.desktop "Desktop Action Disks") == OK ]] && printf OK || printf MISS)"
  live_system_status_state="$([[ $(contains_state bin/seven-installer "memory_ready") == OK && $(contains_state bin/seven-installer "power_safe") == OK && $(contains_state bin/seven-installer "boot_mode") == OK && $(contains_state bin/seven-installer "secure_boot") == OK && $(contains_state bin/seven-installer "secure_boot_attention") == OK && $(contains_state bin/seven-installer "graphics_ready") == OK && $(contains_state bin/seven-installer "render_devices") == OK && $(contains_state bin/seven-installer "locale_ready") == OK ]] && printf OK || printf MISS)"
  ...
  live_portal_first_state="$([[ $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-ready "Opening Calamares directly for a stable graphical installation") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-ready "open_calamares_direct") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-ready "Calamares did not stabilize; trying the SevenOS portal fallback") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-ready "open_network_choice") == OK && $(contains_state archiso/profile/airootfs/etc/sevenos/live-hyprland.conf "seven-installer open") == OK && $(contains_state bin/seven-installer "focus_installer_window") == OK && $(contains_state bin/seven-installer "calamares-open.lock") == OK && $(contains_state bin/seven-installer "installer-portal-open.lock") == OK && $(contains_state archiso/profile/airootfs/usr/local/bin/sevenos-live-guard "installer_window_count") == OK ]] && printf OK || printf MISS)"
  live_smoke_state="$("$ROOT_DIR/scripts/live-installer-smoke.sh" --json 2>/dev/null | python -c 'import json,sys; print(json.load(sys.stdin).get("state","MISS"))' 2>/dev/null || printf MISS)"
  ...
  LIVE_PORTAL_FIRST_STATE="$live_portal_first_state" \
  LIVE_SMOKE_STATE="$live_smoke_state" \
...
checks = [
    ...
    },
    {
        ...
        "reason": "The live ISO has a temporary seven user; it must be removed before the users module creates the real account without killing the running live session.",
    },
    {
    ...
    },
    {
        ...
        "required": True,
        "title": "Live first-screen exposes firmware, power and memory readiness",
        "command": "seven-installer live-status --json",
    },
    {
    ...
    {
        "key": "live-installer-portal-first-route",
        "state": "OK" if os.environ["LIVE_PORTAL_FIRST_STATE"] == "OK" and os.environ["LIVE_SMOKE_STATE"] == "OK" else "MISS",
        "required": True,
        "title": "Live installer opens the SevenOS portal first, then Calamares on explicit action",
        "command": "scripts/live-installer-smoke.sh --json",
    },
    {
        "key": "live-freshness",
...
keys = {
    ...
    "live-installer-portal-first-route",
    "calamares-branding",
}
...
Next engineering steps:
  ...
  - keep SevenOS finalization offline-first after unpackfs
