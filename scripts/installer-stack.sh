...
release_json() {
  ...
  calamares_livecleanup_state="$([[ $(contains_state installer/calamares/settings.conf "shellprocess@livecleanup") == OK && $(contains_state installer/calamares/settings.conf "shellprocess-livecleanup.conf") == OK && $(contains_state installer/calamares/modules/shellprocess-livecleanup.conf "seven-calamares-livecleanup") == OK && $(contains_state installer/calamares/modules/shellprocess-livecleanup.conf "/bin/bash -lc") == OK && $(contains_state bin/seven-calamares-livecleanup "without touching running live processes") == OK && $(contains_state archiso/profile/airootfs/root/customize_airootfs.sh "seven-calamares-livecleanup") == OK ]] && printf OK || printf MISS)"
