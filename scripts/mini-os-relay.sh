...
RELATIONS = [
    ...
    },
    {
        "from": "forge",
        "to": "atlas",
        "channel": "product-to-reference",
        "objects": ["documentation", "map", "research-note", "reference-request"],
        "phrase": "Forge utilise Atlas pour organiser la documentation, les cartes et les références.",
        "protected_boundary": "Atlas indexe les connaissances sans prendre possession du workspace Forge.",
    },
    {
        "from": "atlas",
        "to": "studio",
        "channel": "reference-to-creation",
