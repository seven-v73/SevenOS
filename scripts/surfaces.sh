...
surfaces = [
    ...
    },
    {
        "key": "notes",
        "title": "Seven Notes",
        "role": "local notes and home widget capture",
        "command": "seven notes",
        "native": "bin/seven-notes-native",
        "desktop": "seven-hub/seven-notes.desktop",
        "actions": ["notes.open", "notes.quick", "notes.widget"],
        "dynamic": True,
    },
    {
        "key": "widgets",
        "title": "Seven Widgets",
        "role": "optional home-screen widget layer",
        "command": "seven widgets menu",
        "native": "bin/seven-widgets-native",
        "desktop": None,
        "actions": ["widgets.menu", "widgets.settings", "widgets.open"],
        "dynamic": True,
    },
    {
        "key": "tools",
        "title": "SevenOS Tools",
        "role": "native dashboard for daily SevenOS tools",
        "command": "seven tools open",
        "native": "bin/seven-tools-native",
        "desktop": "seven-hub/seven-tools.desktop",
        "actions": ["tools.open", "tools.status", "tools.doctor"],
        "dynamic": True,
    },
    {
        "key": "terminal",
