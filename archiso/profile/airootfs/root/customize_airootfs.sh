...
# /usr/local/bin/seven-calamares-* are stable wrappers tracked directly in the
# ISO profile. Do not overwrite them here: Calamares runs them inside the
# installed root before /opt/SevenOS has proven itself.
