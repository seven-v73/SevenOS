...
file_permissions=(
  ...
  ["/usr/local/bin/seven-calamares-finalize"]="0:0:755"
  ["/usr/local/bin/seven-calamares-livecleanup"]="0:0:755"
  ["/usr/local/bin/seven-calamares-finalize-target"]="0:0:755"
  ["/usr/local/bin/seven-calamares-livecleanup-target"]="0:0:755"
  ["/etc/sevenos/live-hyprland.conf"]="0:0:644"
  ["/etc/sevenos/live-hyprpaper.conf"]="0:0:644"
  ["/usr/share/sevenos/live-background.png"]="0:0:644"
